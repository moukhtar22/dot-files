...
# ================================
# Automatic Installation Script for Dotfiles + AMD CPU/GPU
# Repository: https://github.com/moukhtar22/dot-files
# Author: Your Name
# ================================
...
PACMAN_PACKAGES=(
    amd-ucode vulkan-radeon libva-mesa-driver mesa-vdpau clinfo btop htop-vim iotop-c fastfetch duf progress s-tui
    perl-image-exiftool zsh yt-dlp starship reflector quarto-cli-bin pandoc-bin less gum graphviz gocryptfs eza git
    git-crypt git-delta topgrade ttyper rsync rm-improved glow prettyping bob cht.sh-git bat yazi ffmpeg ffmpegthumbnailer
    p7zip jq poppler fd ripgrep ripgrep-all fzf zoxide imagemagick mmv-c-git ripdrag rclone bc carapace-bin impala bluetui
    fcitx5 fcitx5-chinese-addons fcitx5-material-color ttf-noto-cjk ttf-wqy-microhei ttf-wqy-zenhei i3-gaps polybar rofi
    alacritty neovim pamixer scrot maim xclip feh dunst playerctl pipewire pipewire-alsa pipewire-audio pipewire-jack
    pipewire-pulse pipewire-zeroconf wireplumber pwvucontrol gnome-disk-utility gpart otf-apple-fonts ttf-apple-emoji
    noto-fonts-cjk ntfs-3g tectonic tree-sitter tree-sitter-cli zathura zathura-pdf-mupdf telegram-desktop nicotine+ audacity
    gimp-devel mpv termusic microsoft-edge-stable-bin librewolf-bin zen-browser-bin firefox-tridactyl-native brightnessctl
    playerctl nm-connection-editor bluez-utils ananicy-cpp nftables iptables-nft firejail pass
)
...
REPO_URL="https://github.com/moukhtar22/dot-files.git"
INSTALL_DIR="$HOME/dot-files"
